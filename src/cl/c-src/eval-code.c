...
LP p_lsp_EVAL_2DSEQUENCE(ARGC argc, LP v_FORMS_0, LP v_VENV_1, LP v_FENV_2, LP v_TENV_3, LP v_BENV_4);
LP p_lsp_EVAL_2DHAIRY_2DEXTEND_2DVAR_2DENV(ARGC argc, LP v_VENV_0, LP v_LAMBDA_2DLIST_1, LP v_ARGS_2, LP v_FENV_3, LP v_TENV_4, LP v_BENV_5);
LP p_lsp_EVAL_2DUNDO_2DSPECIAL_2DBINDINGS(ARGC argc, LP v_SPECIALS_0, LP v_SPECIAL_2DVALUES_1);
LP p_lsp_EVAL_2DSIMPLE_2DEXTEND_2DVAR_2DENV(ARGC argc, LP v_CURRENT_2DENV_0, LP v_NEW_2DVARS_1, LP v_NEW_2DVALS_2);
void arg_limit_exceeded(int len);
